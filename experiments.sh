...
do 
    ...
    echo "scan $j"
    echo ""
    ./app/rcs -seed 4545 -scan $j -r 14 -l 100 -phi 360 -timeout 10000 -bias 0.05 -save_pc -save_interp -var_curve
    ./app/rcs_star -seed 4545 -scan $j -r 14 -l 100 -phi 360 -timeout 10000 -bias 0.05 -save_pc -save_interp -var_curve
    ...
    do
        ...
        echo "seed $i scan $j"
        echo ""
        ./app/rrt -seed $i -scan $j -r 14 -l 100 -phi 360 -timeout 10000 -bias 0.05 -save_pc -save_interp -var_curve
        ./app/aorrt -seed $i -scan $j -r 14 -l 100 -phi 360 -timeout 10000 -bias 0.05 -save_pc -save_interp -var_curve
