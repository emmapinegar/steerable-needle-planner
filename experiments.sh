...
phi_arr=(180)
rads=(15 25 50) #(25 50 100 250)
sgs=(1500 1500 1500) #(500 1000 1500 2000)
seed=8965
scan=1
ell=100
timeout=100000
...
#         # ./app/rrt -seed 8965 -scan $j -r 250 -l 100 -phi 90 -timeout 10 -bias 0.05 -sg_index $i -num_sg 500 -stats_file $test_file
...
do
    ...
    do
        ...
        ./app/rrt -seed 8965 -scan $j -r 250 -l 100 -phi 180 -timeout 10 -bias 0.05 -sg_index 2000 -num_sg 500 -stats_file "./../data/output/planner_verify.txt" -multi -var_curve
        # ./app/rrt -seed 8965 -scan $j -r 100 -l 100 -phi 90 -timeout 10 -bias 0.05 -sg_index 1500 -num_sg 500 -stats_file "./../data/output/planner_stats.txt"
        # ./app/rrt -seed 8965 -scan $j -r 50 -l 100 -phi 90 -timeout 10 -bias 0.05 -sg_index 1000 -num_sg 500 -stats_file "./../data/output/planner_stats.txt"
        # ./app/rrt -seed 8965 -scan $j -r 25 -l 100 -phi 90 -timeout 10 -bias 0.05 -sg_index 500 -num_sg 500 -stats_file "./../data/output/planner_stats.txt"
        # ./app/rrt -seed 8965 -scan $j -r 15 -l 100 -phi 90 -timeout 10 -bias 0.05 -sg_index 0 -num_sg 500 -stats_file "./../data/output/planner_stats.txt"
...
#             ./app/rrt -seed $seed -scan $j -r ${rads[$i]} -l $ell -phi 90 -timeout $multi_timeout -bias $bias -sg_index ${sgs[$i]} -num_sg $num_sg -stats_file $test_file -var_curve -multi
#             ./app/aorrt -seed $seed -scan $j -r ${rads[$i]} -l $ell -phi 90 -timeout $multi_timeout -bias $bias -sg_index ${sgs[$i]} -num_sg $num_sg -stats_file $test_file -var_curve -multi
#             ./app/rcs -seed $seed -scan $j -r ${rads[$i]} -l $ell -phi 90 -timeout $multi_timeout -bias $bias -sg_index ${sgs[$i]} -num_sg $num_sg -stats_file $test_file -var_curve -multi
#             ./app/rcs_star -seed $seed -scan $j -r ${rads[$i]} -l $ell -phi 90 -timeout $multi_timeout -bias $bias -sg_index ${sgs[$i]} -num_sg $num_sg -stats_file $test_file -var_curve -multi
...
#         for ((i=0;i<${#rads[@]};i++));                                         # https://www.geeksforgeeks.org/linux-unix/array-basics-shell-scripting-set-2-using-loops/
#         do
#             echo ""
#             echo "seed $i scan $j radius ${rads[$i]}"
#             echo ""
