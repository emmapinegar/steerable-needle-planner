...
seed_array=(8965)
scan_array=(3)                  # https://www.digitalocean.com/community/tutorials/arrays-in-shell-scripts
phi_arr=(45)
rads=(15)
sgs=(0)
seed=8965
...
test_file="./../data/output/planner_stats_multi_debug_longer_3.txt"
stein_file="./../data/output/planner_stats_multi_stein.txt"
i=0
...
#         ./app/rrt -seed 8965 -scan $j -r 15 -l 100 -phi 90 -timeout 10 -bias 0.05 -sg_index $i -num_sg 10 -stats_file "./../data/output/planner_stats_3.txt"
...
do
    ...
    do
        ...
        # https://www.geeksforgeeks.org/linux-unix/array-basics-shell-scripting-set-2-using-loops/
            ...
            # ./app/stein_rrt -seed $seed -scan $j -r ${rads[$i]} -l $ell -phi 180 -timeout $multi_timeout -bias $bias -sg_index ${sgs[$i]} -num_sg $num_sg -stats_file $test_file -var_curve
            # ./app/stein_rrt -seed $seed -scan $j -r ${rads[$i]} -l $ell -phi 180 -timeout $multi_timeout -bias $bias -sg_index ${sgs[$i]} -num_sg $num_sg -stats_file $stein_file -var_curve -multi
